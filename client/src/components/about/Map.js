...
function Map (){
  ...
  >
<Marker key={"little shop of soil"} position={{lat: 40.699359, lng:-73.924092 }} />
  </GoogleMap>
  ...
  render() {
      return (
        <div style={{width: "30vw", height:"20vw"}}>
          <MapContainer 
          googleMapURL={"https://maps.googleapis.com/maps/api/js?key=AIzaSyBve2YcpUXvcwNRsHCH4-vPJzz_tCMrU9U"}
